<script>
    ...
    import { CardText, Styles } from '@sveltestrap/sveltestrap';
    import { Button, Icon, colorMode, Card, Container } from '@sveltestrap/sveltestrap';

</script>
    
<svelte:head>
    <title>SOS2324-28 Manager</title>
</svelte:head>
